...
if st.checkbox('Parameters Legend'):
    ...
    st.markdown('**Lower limit to calculate the stokes** (_wave_inf_): Set the lower limit of the Stokes region of the spectrum to calculate the average intensity.')
    st.markdown('**Upper limit to calculate the stokes** (_wave_sup_): Set the upper limit of the Stokes region of the spectrum to calculate the average intensity.')
